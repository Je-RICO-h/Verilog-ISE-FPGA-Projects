...
HD_PWD='C:/Users/erikp/Desktop/Egyetem/3_Felev/Ujrakonfiguralhato Aramkorok/Projektek/knight_rider/knight_rider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log knightrider.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source knightrider.tcl -notrace
