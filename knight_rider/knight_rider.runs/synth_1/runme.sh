...
HD_PWD='C:/Users/erikp/Desktop/Egyetem/3_Felev/Ujrakonfiguralhato Aramkorok/Projektek/knight_rider/knight_rider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log knightrider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source knightrider.tcl
