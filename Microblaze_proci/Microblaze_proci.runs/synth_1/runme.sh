...
HD_PWD='C:/Users/erikp/Desktop/Egyetem/3_Felev/Ujrakonfiguralhato Aramkorok/Projektek/Microblaze_proci/Microblaze_proci.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mcs_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mcs_top.tcl
