...
HD_PWD='C:/Users/erikp/Desktop/Egyetem/3_Felev/Ujrakonfiguralhato Aramkorok/Projektek/Microblaze_proci/Microblaze_proci.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mcs_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mcs_top.tcl -notrace
