...
HD_PWD='C:/Users/erikp/Desktop/Egyetem/3_Felev/Ujrakonfiguralhato Aramkorok/Projektek/PROJEKT_FELADAT/VGA_BOUNCE.runs/clk_65mhz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_65mhz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_65mhz.tcl
