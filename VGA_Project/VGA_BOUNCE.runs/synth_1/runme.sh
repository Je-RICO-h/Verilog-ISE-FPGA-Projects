...
HD_PWD='C:/Users/erikp/Desktop/Egyetem/3_Felev/Ujrakonfiguralhato Aramkorok/Projektek/PROJEKT_FELADAT/VGA_BOUNCE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kacsa_bounce_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kacsa_bounce_top.tcl
