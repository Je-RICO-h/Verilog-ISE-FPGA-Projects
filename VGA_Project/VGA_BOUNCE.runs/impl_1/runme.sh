...
HD_PWD='C:/Users/erikp/Desktop/Egyetem/3_Felev/Ujrakonfiguralhato Aramkorok/Projektek/PROJEKT_FELADAT/VGA_BOUNCE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kacsa_bounce_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kacsa_bounce_top.tcl -notrace
