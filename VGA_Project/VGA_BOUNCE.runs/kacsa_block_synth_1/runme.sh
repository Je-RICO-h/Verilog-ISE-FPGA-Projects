...
HD_PWD='C:/Users/erikp/Desktop/Egyetem/3_Felev/Ujrakonfiguralhato Aramkorok/Projektek/VGA_BOUNCE/VGA_BOUNCE.runs/kacsa_block_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kacsa_block.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kacsa_block.tcl
