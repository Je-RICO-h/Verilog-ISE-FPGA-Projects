...
HD_PWD='C:/Users/erikp/Desktop/Egyetem/3_Felev/Ujrakonfiguralhato Aramkorok/Projektek/ADC/ADC.runs/xadc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xadc_0.tcl
